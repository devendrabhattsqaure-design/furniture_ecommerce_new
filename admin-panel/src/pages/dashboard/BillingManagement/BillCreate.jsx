  ...
  const fetchOrganization = async () => {
    try {
      ...
      if (response.ok) {
        ...
        console.log(data.organization,'fulldata');
        
        // Set default GST type from organization
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-gray-600">Add products and customer details to create a bill</p>
              </div>
            </div>
          </div>
          {organization && (
      ...
      <form onSubmit={handleSubmit} className="px-4 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {/* GST Selection */}
            <div className="bg-white rounded-xl shadow-sm border p-6">
              <h2 className="text-lg font-semibold text-gray-800 mb-4">GST Options</h2>
              ...
              {formData.gst_type === 'with_gst' && organization && (
                <p className="text-sm text-gray-500 mt-2">
                  GST will be calculated at {organization.gst_percentage || 0}% on taxable amount
                </p>
              )}
            </div>
                ...
                <div className="border border-gray-200 rounded-lg max-h-64 overflow-y-auto">
                  {products.length === 0 ? (
                    <div className="text-center p-8 text-gray-500">
                      ...
                      <p className="text-sm">No products found. Try searching for products.</p>
                    </div>
                  ) : (
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  {formData.gst_type === 'with_gst' && (
                    <>
                      ...
                      {tax > 0 && (
                        <div className="flex justify-between items-center">
                          <span>Tax ({formData.tax_percentage || organization?.gst_percentage || 0}%)</span>
                ...
                <div className="border-t pt-4">
                  ...
                  {formData.gst_type === 'with_gst' && organization && (
                    <p className="text-xs text-gray-500 text-right">
                      Includes {formData.tax_percentage || organization.gst_percentage || 0}% GST
                    </p>
                  )}
                </div>
                  ...
                  <div className="bg-gray-50 p-3 rounded-lg space-y-2">
                    ...
                    {dueAmount > 0 && (
                      <div className={`text-xs p-2 rounded ${
                        paymentStatus === 'partial' ? 'bg-yellow-50 text-yellow-600' : 'bg-red-50 text-red-600'
                      }`}>
                ...
                <div className="pt-4 border-t">
                  ...
                  <p className="text-xs text-gray-500 mt-2 text-center">
                    {formData.items.length === 0 ? 'Add at least one product to continue' : 'Review and submit your bill'}
                  </p>
                </div>
              </div>
            </div>
